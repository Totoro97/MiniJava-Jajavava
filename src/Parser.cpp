...
ManualParser::ManualParser() {
  ...
  AddRule(TYPE, { INT, LSQR, RSQR }, {}, TYPE_ARRAY);
  AddRule(TYPE, { BOOLEAN }, {}, TYPE_BOOL);
  AddRule(TYPE, { INT }, {}, TYPE_INT);
  AddRule(TYPE, { ID }, {}, TYPE_CLASS);
  ...
  AddRule(EXPRESSION, { INT_LITERAL }, {}, EXPRESSION_INT);
  AddRule(EXPRESSION, { TRUE }, {}, EXPRESSION_BOOL);
  AddRule(EXPRESSION, { FALSE }, {}, EXPRESSION_BOOL);
  AddRule(EXPRESSION, { ID }, {}, EXPRESSION_ID);
  AddRule(EXPRESSION, { THIS }, {}, EXPRESSION_THIS);
  AddRule(EXPRESSION, { NEW, INT, LSQR, EXPRESSION, RSQR }, { NEW, LSQR, RSQR }, EXPRESSION_NEW_ARRAY);
