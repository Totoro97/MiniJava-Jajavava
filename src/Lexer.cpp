...
ManualLexer::ManualLexer() {
  ...
  head = new NFANode();
  AddWhiteSpaceEdge(head, head);
  AddPath(head, std::string("true"), TRUE);
  AddPath(head, std::string("false"), FALSE);
  AddPath(head, std::string("class"), CLASS);
  AddPath(head, std::string("public"), PUBLIC);
  AddPath(head, std::string("static"), STATIC);
  AddPath(head, std::string("void"), VOID);
  AddPath(head, std::string("main"), MAIN);
  AddPath(head, std::string("String"), STRING);
  AddPath(head, std::string("extends"), EXTENDS);
  AddPath(head, std::string("int"), INT);
  AddPath(head, std::string("boolean"), BOOLEAN);
