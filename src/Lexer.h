...
enum TokenTag {
  ...
  GOAL, MAIN_CLASS, CLASS_DECLARATION, CLASS_DECLARATIONS, VAR_DECLARATION, VAR_DECLARATIONS,
  METHOD_DECLARATION, METHOD_DECLARATIONS, TYPE, STATEMENT, STATEMENTS,
  EXPRESSION, COMMA_EXPRESSIONS, EXTENDS_IDENTIFIER,
